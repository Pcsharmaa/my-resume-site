...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Gradient Glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] gradient-overlay pointer-events-none" />
      ...
      <div className="section-container relative z-10 py-32 md:py-40">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in-up">
            Hi, I'm{' '}
            <span className="gradient-text">Prafull Sharma</span>
          </h1>

          {/* Title */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-4 animate-fade-in-delay-1">
            <span className="text-primary font-mono"> Asp Dot Net Full Stack Developer</span>
          </p>

          {/* Experience */}
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto animate-fade-in-delay-2">
          ...
          {/* Contact Info */}
          <div className="flex flex-wrap items-center justify-center gap-6 mb-10 animate-fade-in-delay-3">
            <a
          ...
          >
            ...
            <a
            href="https://www.google.com/maps/place/Delhi+NCR"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="flex items-center gap-2 text-sm text-muted-foreground hover:underline cursor-pointer">
